...
export const GuardHistory = () => {
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute("download", `guard_scan_history_${new Date().toISOString().split('T')[0]}.csv`);
    ...
    <div className="space-y-6 animate-fade-in max-w-5xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-600 mt-2">Log and audit records of all verified student leave passes</p>
        </div>
      ...
      <Card>
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
          ...
          <div className="w-full md:w-80 relative">
            ...
            <input
              type="text"
              placeholder="Search by student name, room..."
          ...
          <div className="py-20 text-center">
            ...
            <p className="text-slate-400 text-sm mt-1">
              {searchQuery || selectedYearFilter !== "all"
                ...
                : "Verify leaves at the scanner page to populate history logs."}
            </p>
          </div>
        ) : (
